...
// Valid indicates whether the value is a known member of the BackupStatusConditionsStatus enum.
func (e BackupStatusConditionsStatus) Valid() bool {
	switch e {
	case BackupStatusConditionsStatusFalse:
		return true
	case BackupStatusConditionsStatusTrue:
		return true
	case BackupStatusConditionsStatusUnknown:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupStatusExecutionMode enum.
func (e BackupStatusExecutionMode) Valid() bool {
	switch e {
	case BackupStatusExecutionModeJob:
		return true
	case BackupStatusExecutionModeProviderManaged:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupClassSpecExecutionMode enum.
func (e BackupClassSpecExecutionMode) Valid() bool {
	switch e {
	case BackupClassSpecExecutionModeJob:
		return true
	case BackupClassSpecExecutionModeProviderManaged:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupClassStatusConditionsStatus enum.
func (e BackupClassStatusConditionsStatus) Valid() bool {
	switch e {
	case BackupClassStatusConditionsStatusFalse:
		return true
...
// Valid indicates whether the value is a known member of the BackupStorageSpecType enum.
...
// Valid indicates whether the value is a known member of the InstanceStatusConditionsStatus enum.
func (e InstanceStatusConditionsStatus) Valid() bool {
	switch e {
	case InstanceStatusConditionsStatusFalse:
		return true
...
// Valid indicates whether the value is a known member of the InstanceStatusPhase enum.
func (e InstanceStatusPhase) Valid() bool {
	switch e {
	case InstanceStatusPhaseFailed:
		return true
	case InstanceStatusPhaseInitializing:
		return true
	case InstanceStatusPhasePending:
		return true
	case InstanceStatusPhaseProvisioning:
		return true
	case InstanceStatusPhaseReady:
		return true
	case InstanceStatusPhaseRestoring:
		return true
	case InstanceStatusPhaseResuming:
		return true
	case InstanceStatusPhaseSuspended:
		return true
	case InstanceStatusPhaseSuspending:
		return true
...
// Valid indicates whether the value is a known member of the ProviderStatusConditionsStatus enum.
func (e ProviderStatusConditionsStatus) Valid() bool {
	switch e {
	case ProviderStatusConditionsStatusFalse:
		return true
...
// Valid indicates whether the value is a known member of the RestoreStatusConditionsStatus enum.
func (e RestoreStatusConditionsStatus) Valid() bool {
	switch e {
	case RestoreStatusConditionsStatusFalse:
		return true
	case RestoreStatusConditionsStatusTrue:
		return true
	case RestoreStatusConditionsStatusUnknown:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RestoreStatusExecutionMode enum.
func (e RestoreStatusExecutionMode) Valid() bool {
	switch e {
	case RestoreStatusExecutionModeJob:
		return true
	case RestoreStatusExecutionModeProviderManaged:
		return true
	default:
		return false
	}
...
type Instance struct {
	...
	Spec struct {
		...
		Components *map[string]struct {
			...
			// SchedulingPolicy SchedulingPolicy controls where this component's pods run: node
			...
			SchedulingPolicy *struct {
				...
				// NodeSelector NodeSelector must match a node's labels for the pods to be schedulable
				// onto that node.
				NodeSelector *map[string]string `json:"nodeSelector,omitempty"`

				// SchedulerName SchedulerName selects the scheduler that dispatches the pods.
				// When omitted the cluster's default scheduler is used.
				SchedulerName *string `json:"schedulerName,omitempty"`

				// Tolerations Tolerations allow the pods to schedule onto nodes carrying matching
			...
			} `json:"schedulingPolicy,omitempty"`
